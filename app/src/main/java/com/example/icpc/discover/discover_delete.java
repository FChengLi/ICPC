...
public class discover_delete extends AppCompatActivity {
    ...
    private void selectArticle() {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            @SuppressLint("Range") String source = cursor.getString(cursor.getColumnIndex("author"));
            @SuppressLint("Range") String content = cursor.getString(cursor.getColumnIndex("content_text"));
